...
def convolve(image, K):
    ...
    for y in np.arange(pad, iH + pad):
        for x in np.arange(pad, iW + pad):
            ...
            # dimensions
            roi = image[y - pad:y + pad + 1, x - pad:x + pad + 1]    # ROI = Region of Interest
    ...
    # rescale the output image tobe in the range [0, 255]
...
# using both our custom "convole" functon and OpenCV's 'filter2D'
# function
kernelBank = (
...
# python convolutions.py --image beagle.png