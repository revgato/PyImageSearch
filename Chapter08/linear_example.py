...
# initialize the class labels and get the seed of the pseudorandom
# number generator so we can reproduce our results
labels = ["dog", "cat", "panda"]
np.random.seed(1)

# randomly initialize our weight matrix and bias vector -- in a
# *real* training and c;assification task, these parameters would
...
#draw the labal with the highest score on the image as our
#prediction
