...
# be downloading along withc the total number of images downloaded
# thus far
...
for i in range(0, args['num_images']):
    ...
    # handel if any exceptions are thrown during the download precess
    except:
        print('[INFO] error downloading image...')

    # insert a small sleep to be courteous to the sever
    time.sleep(0.1)
